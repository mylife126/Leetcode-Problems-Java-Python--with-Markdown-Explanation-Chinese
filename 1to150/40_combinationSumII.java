...
[10,1,2,7,6,1,5]， 其中 1 2 5 成立， 而当递归来到 2 这一层， 2 1 5 也是同样的答案。 所以这就重复了。 为了避免这样的重复，我们需要把array sort， [1 1 2 5 6 7 10], 这样你会发觉:
idx = 0  i = 1   1 2 5成立return到第一层
idx = 1  i = 1   1 由于sort过，所以可以发觉 当 i > idx 且 array[i] = array[i -1]这个情况就可以直接continue，跳过。
